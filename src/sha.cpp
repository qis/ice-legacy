...
void sha<1>::finish()
{
  SHA1_Final(value_.data(), context_.get());
}
...
void sha<224>::finish()
{
  SHA224_Final(value_.data(), context_.get());
}
...
void sha<256>::finish()
{
  SHA256_Final(value_.data(), context_.get());
}
...
void sha<384>::finish()
{
  SHA384_Final(value_.data(), context_.get());
}
...
void sha<512>::finish()
{
  SHA512_Final(value_.data(), context_.get());
}
